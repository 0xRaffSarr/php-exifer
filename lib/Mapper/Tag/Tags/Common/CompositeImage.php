<?php
/**
 * PHP Exifer Tag CompositeImage: Defines CompositeImage Tag.
 *
...
class CompositeImage extends Tag
{
    const ID = '0xa460';

    const NAME = 'CompositeImage';
    ...
    public function setValue($value)
    {
        if(!in_array($value, array_keys($this->valueDescription))) {
            throw new InvalidDataException('Invalid CompositeImage value.');
        }
